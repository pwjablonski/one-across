...
export const unpauseTimer = createAction("UNPAUSE_TIMER");

export const incrementTimer = createAction("INCREMENT_TIMER");

export const updateFill = createAction("UPDATE_FILL", grid => ({ grid }));

export const clearPuzzle = createAction("CLEAR_PUZZLE");

export const setSessionData = createAction("SET_SESSION_DATA", sessionData => ({
  sessionData
}));

export const resetSessionData = createAction("RESET_SESSION_DATA");
